...
### 🌐 在线使用（推荐）
- **欢迎页面**: [https://ai-resume-generator.vercel.app/landing.html](https://ai-resume-generator.vercel.app/landing.html)
- **直接使用**: [https://ai-resume-generator.vercel.app](https://ai-resume-generator.vercel.app)

### 💻 本地使用

#### 方法一：从欢迎页面开始
1. 下载项目文件到本地
2. 双击打开 `landing.html` 文件查看应用介绍
3. 点击"开始制作"按钮进入编辑器
4. 开始编辑您的简历！
